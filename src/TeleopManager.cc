...
public:
  TeleopManager() : Node("TeleopManager") {
    ...
    RCLCPP_INFO(this->get_logger(), "TeleopManager iniciado. Botão Y alterna entre modo TERRA e ÁGUA.");
  }
...
private:
  void joy_callback(const sensor_msgs::msg::Joy::SharedPtr msg) {
    ...
    if (msg->buttons[3] == 1 && !last) { 
      ...
      RCLCPP_INFO(this->get_logger(), "Modo alterado: %s", Ground_mode_ ? "TERRA" : "ÁGUA");
    }
    last = msg->buttons[3];
  }
